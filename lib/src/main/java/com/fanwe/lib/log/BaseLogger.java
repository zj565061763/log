...
{
    private static final Map<BaseLogger, Object> MAP_LOGGER = new WeakHashMap<>();
    ...
    {
        for (Map.Entry<BaseLogger, Object> item : MAP_LOGGER.entrySet())
        {
     ...
     * @param context
     */
    public final void setLogFile(int limitMB, Context context)
    {
        if (limitMB <= 0)
        {
